...
\vspace{-0.5cm}
            ...
            \begin{tikzpicture}[
                constraint/.style={rounded corners=2pt,minimum width=5.2cm,
                                  minimum height=0.9cm,font=\footnotesize,align=left,
    ...
    \begin{columns}[T]
        ...
        \vspace{-0.5cm}
            ...
            \begin{tikzpicture}[scale=1.0,transform shape]
                \node[font=\bfseries,primaryBlue] at (1.2,2.8) {Synergy Matrix};
                ...
                \node[font=\small,anchor=west] at (2.6,1.2) {\textcolor{accentGreen}{$\blacksquare$} Benefit};
                \node[font=\small,anchor=west] at (2.6,0.7) {\textcolor{alertRed}{$\blacksquare$} Penalty};
            \end{tikzpicture}
            
            \vspace{0.2cm}
            \begin{warningbox}[Frustration]
                \scriptsize \textbf{70--88\%} of crop rotation pairs have \textbf{negative} synergy\\[2pt]
...
\begin{frame}{Three Complementary Studies}
    \framesubtitle{Comprehensive evaluation of quantum and classical performance}
...
\begin{frame}{Study 1.A: Research Question \& Setup}
    \framesubtitle{Can D-Wave hybrid solvers compete with classical MILP on linear problems?}
...
\begin{frame}{Study 1.A: Hybrid Solver Results}
    \framesubtitle{D-Wave vs Gurobi on Variant A}
...
\begin{frame}{Study 2.A: Research Question \& Setup}
    \framesubtitle{How do decomposition strategies affect pure QPU performance?}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}\scriptsize
                \item \textbf{Formulation:} Variant A (Binary Allocation)
                \item \textbf{Challenge:} QPU embeds $<$500 variables
                \item \textbf{Scale:} 10 to 1,000 farms
        ...
        \begin{column}{0.55\textwidth}
            ...
            \begin{table}[h]\small
                ...
                \begin{tabular}{lccc}
                    ...
                    \midrule
                    \rowcolor{accentGreen!20} Gurobi (optimal) & 0.4292 & 0.0\% & 5 \\
...
\begin{frame}{Study 2.B: Research Question \& Setup}
    \framesubtitle{Can quantum annealing outperform classical solvers on frustrated problems?}
...
\begin{frame}{Hierarchical Decomposition Framework}
    \framesubtitle{Four-phase approach to enable large-scale QPU optimization}
    
    \centering
    \begin{tikzpicture}[
        phase/.style={rounded corners=8pt,minimum width=3.2cm,minimum height=2.2cm,
                     font=\scriptsize,align=center,text=white,
                     drop shadow={opacity=0.3,shadow xshift=1mm,shadow yshift=-1mm}},
        arrow/.style={->,very thick,line width=2pt},
        desc/.style={font=\tiny,align=center,text width=3cm}
    ]
        % Phase 1: Decompose
        ...
        % Phase 2: Aggregate
        \node[phase,fill=secondaryBlue] (p2) at (4,0) {
        ...
        % Phase 3: Solve
        \node[phase,fill=accentTeal] (p3) at (8,0) {
            \Large\faMicrochip\\[4pt]
        ...
        % Phase 4: Refine
        \node[phase,fill=accentGreen] (p4) at (12,0) {
            \Large\faSyncAlt\\[4pt]
        ...
        % Feedback loop from Refine back to Aggregate
        % \draw[arrow,accentGreen!60,dashed] (p4.south) -- ++(0,-1.4) -| (p2.south);
        ...
        \node[rounded corners=6pt,fill=white,draw=mutedGray,align=center,font=\scriptsize,inner sep=6pt] at (6,-3.2) {
            \textbf{Key:} Enables scaling from 500 vars (QPU limit) to 27,000+ vars via hierarchical partitioning
        };
    \end{tikzpicture}
\end{frame}
...
Gurobi Time & 0.1-10s & 0.1-10s & 300s (timeout) \\
...
\begin{frame}{Crop Rotation Parameters: Agronomic Grounding}
...
\begin{frame}{Decomposition Strategies for Large Problems}
    ...
    \begin{highlightbox}
        \centering\small
        \textbf{Why Decomposition?} The MinorMiner embedding algorithm fails above 160 variables at $40\%$ graph density.
    \end{highlightbox}
\end{frame}

\begin{frame}{Why Does Gurobi Struggle with Crop Rotation?}
\small
\begin{columns}[T]
\begin{column}{0.55\textwidth}
...
\begin{frame}{Solution Composition Analysis}
    \centering
    \includegraphics[width=0.55\textwidth]{images/Plots/solution_composition_pies.pdf}
