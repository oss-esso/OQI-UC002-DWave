...
\begin{frame}{Data: Real-World Agricultural Dataset}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \begin{tikzpicture}[
                group/.style={rounded corners=2pt,minimum width=4.8cm,minimum height=0.5cm,
                             font=\scriptsize,align=left,text=white}
            ]
                \node[group,fill=alertRed!80] at (0,0) {Animal Protein (5): Beef, Chicken, Egg...};
                \node[group,fill=warmOrange!80] at (0,-0.65) {Fruits (9): Apple, Banana, Mango...};
                \node[group,fill=accentGreen!80] at (0,-1.3) {Legumes (4): Chickpeas, Tofu...};
                \node[group,fill=primaryBlue!80] at (0,-1.95) {Staples (2): Corn, Potato};
                \node[group,fill=accentTeal!80] at (0,-2.6) {Vegetables (7): Spinach, Tomatoes...};
            \end{tikzpicture}
        ...
        \begin{column}{0.48\textwidth}
            ...
            % \begin{highlightbox}
            %     \centering
            %     \small Environmental impact is \textbf{negatively weighted} to minimize harm
            % \end{highlightbox}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Three Complementary Studies}
    ...
    \begin{tikzpicture}[
        ...
        % Arrows
        \draw[->,very thick,primaryBlue!60] (s1.east) -- node[above,font=\tiny,text=mutedGray] {} (s2.west);
        \draw[->,very thick,accentTeal!60] (s2.east) -- node[above,font=\tiny,text=mutedGray] {} (s3.west);
    \end{tikzpicture}
