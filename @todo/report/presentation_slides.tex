...
\begin{frame}{Benefit Score Distribution}
    \centering
    \includegraphics[width=0.5\textwidth]{images/Plots/02_benefit_heatmap.png}
...
\begin{frame}{Study 1: Hybrid Solver Results}
    ...
    \centering
    \includegraphics[width=0.75\textwidth]{images/Plots/study1_hybrid_performance.pdf}
...
\begin{frame}{Study 2: Pure QPU Benchmark}
    \centering
    \includegraphics[width=0.5\textwidth]{images/Plots/qpu_benchmark_comprehensive.png}
...
\begin{frame}{Study 2: Time Breakdown Analysis \& Solution Quality at 1,000 Farms}
\vspace{-0.8cm}
    \begin{columns}[T]
...
\begin{frame}{Study 3: Comprehensive Scaling (Variant B)}
    \centering
    \includegraphics[width=0.85\textwidth]{images/Plots/quantum_advantage_comprehensive_scaling.pdf}
...
\begin{tabular}{lcccc}
\toprule
\textbf{Metric} & \textbf{Study 1.A} & \textbf{Study 2.A} & \textbf{Study 2.B} & \textbf{Overall} \\
\midrule
