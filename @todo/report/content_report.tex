...
\begin{enumerate}
    ...
    \item \textbf{Violations are minor contributors:} The majority of the optimality gap is structural, not caused by constraint violations
\end{enumerate}
...
\begin{itemize}
    \item \textbf{QPU:} Dominated by cluster count $\rightarrow$ 6-Food takes longer due to more clusters
    \item \textbf{Gurobi:} Dominated by constraint density $\rightarrow$ 6-Food has 6.8$\times$ worse MIP gaps due to tighter rotation coupling with only 6 crop families
\end{itemize}
