...
\begin{itemize}
    \item Demographics: Age, gender distribution, pregnant and lactating women (PLW)
...
\begin{itemize}
    \item Culturally acceptable foods from the Diet Quality Questionnaire Database
...
\begin{itemize}
    \item Crop yields per hectare for selected varieties
