...
\midrule
5 & 90 & 4.078 & 300.0 & 3.452 & 15.3 & 15.1$\times$ & 3.256 & 20.2 \\
10 & 180 & 7.175 & 300.1 & 6.157 & 14.2 & 8.7$\times$ & 6.067 & 15.4 \\
15 & 270 & 11.526 & 300.1 & 9.890 & 14.2 & 6.0$\times$ & 9.947 & 13.7 \\
20 & 360 & 14.889 & 300.2 & 13.209 & 11.3 & 5.2$\times$ & 12.842 & 13.8 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    Average speedup of 8.8$\times$ 
    with 13.8\% average gap.
    
    \item \textbf{Spatial-Temporal Performance}: 
    Average speedup of 7.2$\times$ 
