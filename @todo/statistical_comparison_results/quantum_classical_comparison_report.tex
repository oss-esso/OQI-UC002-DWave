...
\begin{itemize}
    ...
    \item \textbf{Classical solver}: Gurobi with 100s timeout
...
\midrule
5 & 90 & 4.078 & 100.1 & 0.000 & 0.0 & 1.0$\times$ & 0.000 & 0.0 \\
10 & 180 & 7.184 & 100.2 & 0.000 & 0.0 & 1.0$\times$ & 0.000 & 0.0 \\
15 & 270 & 11.631 & 100.1 & 0.000 & 0.0 & 1.0$\times$ & 0.000 & 0.0 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    Average speedup of 1.0$\times$ 
    with 0.0\% average gap.
...
\begin{itemize}
    \item Classical baseline uses timeout (100s), not proven optimal
...
\begin{itemize}
    \item Both methods achieve $>$1$\times$ speedup over classical optimization
