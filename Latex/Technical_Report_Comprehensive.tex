...
This chapter presents the complete set of benchmark visualizations with detailed analysis. All figures are generated from the QPU benchmark experiments described in \Cref{ch:methodology}.
...
\begin{itemize}
\item Nutritional Value: Spinach contributes 0.226 (= 0.25 $\times$ 0.903) vs crop average of 0.12
\item Nutrient Density: Spinach contributes 0.187 (= 0.20 $\times$ 0.935) vs crop average of 0.07
\item Environmental Impact: Spinach loses only 0.001 (penalty for 0.004 impact) vs average penalty of 0.02
\item Combined: Spinach achieves total benefit $\sim$0.43 vs crop average of $\sim$0.28
\end{itemize}
...
\begin{itemize}
\item \emph{Green vegetables} (Spinach, Cabbage, Pumpkin) cluster high on nutrition axes with low environmental impact
\item \emph{Meats} (Beef, Pork, Lamb) show high nutrition but cross high on Environmental Impact axis (especially Beef)
\item \emph{Fruits} form a moderate cluster across all dimensions with no extreme highs or lows
\item \emph{Legumes} (Chickpeas, Tempeh, Tofu) show balanced profiles with good affordability
\end{itemize}
