...
\textbf{Geographies and demographics:} The affected populations are widespread, but the solution depends on the chosen region, types of crops, and local producer profiles. By 2050, 68\% of the world's population will live in uraban regions, consuming 80\% of total food production while cities occupy only 3\% of Earth's surface \cite{ZOU2022100624}.
