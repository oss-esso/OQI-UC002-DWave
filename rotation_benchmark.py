...
with different numbers of plots, testing the D-Wave CQM solver.
    ...
    if dwave_token:
        ...
        try:
            ...
            if len(sampleset) > 0:
                ...
                print(f"       ✓ DWave CQM: {'Feasible' if is_feasible else 'Infeasible'}")
                ...
                print(f"       ❌ DWave CQM: No solution returned")
